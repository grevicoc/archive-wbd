...
CREATE TABLE `bahan_baku` (
  ...
  `nama_bahan_baku` varchar(45) NOT NULL,
  `stok` int NOT NULL,
...
--
-- Table structure for table `bahan_baku_resep`
--

DROP TABLE IF EXISTS `bahan_baku_resep`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `bahan_baku_resep` (
  ...
  `jumlah` int NOT NULL,
  PRIMARY KEY (`id_bahan_baku`,`id_resep`),
  KEY `fk_resep_idx` (`id_resep`),
  CONSTRAINT `fk_bahan_baku` FOREIGN KEY (`id_bahan_baku`) REFERENCES `bahan_baku` (`id_bahan_baku`),
  CONSTRAINT `fk_resep_table1` FOREIGN KEY (`id_resep`) REFERENCES `resep` (`id_resep`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `bahan_baku_resep`
--

LOCK TABLES `bahan_baku_resep` WRITE;
/*!40000 ALTER TABLE `bahan_baku_resep` DISABLE KEYS */;
/*!40000 ALTER TABLE `bahan_baku_resep` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `log_request` (
  ...
  KEY `index_log_request_ip_address_endpoint` (`ip_address`,`endpoint`)
...
CREATE TABLE `request` (
  ...
  KEY `id_resep_request_idx` (`id_resep`),
  CONSTRAINT `fk_resep_table2` FOREIGN KEY (`id_resep`) REFERENCES `resep` (`id_resep`)
...
-- Dump completed on 2021-11-17  9:05:22
